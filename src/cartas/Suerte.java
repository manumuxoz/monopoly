...
public class Suerte extends Carta {
    ...
    @Override
    protected void accion(Jugador actual, Casilla casilla, ArrayList<ArrayList<Casilla>> posiciones, ArrayList<Jugador> jugadores, int numero) {
        switch (numero) {
            case 0: avanzaSolar(actual, (Solar) casilla);
            case 1: veCarcel(actual, posiciones);
            case 2: boteLoteria(actual);
            case 3: elegidoPresidente(actual, jugadores);
            case 4: retrocedeTres(actual, posiciones);
            case 5: multa(actual);
            case 6: avanzaTransporte(actual, posiciones);
        }
    }
}
